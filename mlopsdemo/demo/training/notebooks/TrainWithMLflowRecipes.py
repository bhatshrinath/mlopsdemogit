...
# ``demo/assets/model-workflow-asset.yml``
#
...
if config['experiment']['name'].startswith(f"/{env}-demo-experiment"):
    print("WARNING: The experiment name may not have been set correctly. Please confirm that the experiment name in the profile YAML file matches the experiment_name variable in demo/databricks.yml.")
