...
Refer to [Local development and dev workspace](../demo/assets/README.md#local-development-and-dev-workspace) 
...
You can iterate on the sample ML code by running the provided `demo/training/notebooks/Train.py` notebook on Databricks using
