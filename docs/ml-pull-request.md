...
Opening a pull request will trigger a[workflow](../.github/workflows/demo-run-tests.yml) 
...
* [Staging workspace registered model](https://adb-xxxx.xx.azuredatabricks.net/ml/models/staging-demo-model)
* [Prod workspace registered model](https://adb-4079498746205223.3.azuredatabricks.net/ml/models/prod-demo-model). 
